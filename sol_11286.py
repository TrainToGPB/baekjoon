...
#     if num_in == 0:
#         if abs_heaps:
#             print(abs_heaps.popleft())
#         else:
#             print(0)
#     else:
#         abs_heaps.appendleft(num_in)
#         abs_heaps = deque(sorted(abs_heaps, key=lambda x: abs(x)))
...
for _ in range(n):
    ...
    if num_in == 0:
        if abs_heaps:
            _, value = heapq.heappop(abs_heaps)
            print(value)
        else:
            print(0)
    else:
        heapq.heappush(abs_heaps, (abs(num_in), num_in))
